            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12" id="formauth">
                        <form action="ciblecreate.php" method="POST" class="form">
                            <fieldset>
                                <legend style="color:white">Création de compte</legend>
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="phone" class="form-control" placeholder="0976761610" id="phone" required>
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="creation_auteur.php" style="background-color:white;font-style: bold;"><h6 class="glyphicon glyphicon-book">Création_Compte_Auteur</h6></a>
                                </div>
                            </fieldset>
                        </form>
                    </div>
