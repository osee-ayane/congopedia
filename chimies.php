            ...
            <aside>
                <div class="row" id="contenu">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="result_ad">
                       <h2 style="color: rgb(92, 209, 254);text-align: center;">Tous les livres de <?php echo $_SESSION['ndom']; ?></h2><br>
                        <div class="row">
                            <!-- <div class="col-xs-10"> -->
                                    <!-- Affichage livre automatiquement -->
                                            <?php
                                                        //premier ligne
                                                        $rech = $cn->prepare('SELECT * FROM (ouvrage o INNER JOIN t_auteur t ON t.uid = o.id_aut) INNER JOIN domaine d ON d.did = o.id_dom WHERE d.nom_domaine = ? limit 0,100');
                                                        $rech->execute(array($_SESSION['ndom']));
